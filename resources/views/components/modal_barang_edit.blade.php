        ...
        <div class="modal-body">
            <form id="form-edit-barang" action="" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        <label for="edit_kategori_barang" class="form-label">Kategori</label>
                    ...
                    <div class="form-group">
                        <label for="edit_stok_barang" class="form-label">Stok</label>
                        <input type="number" name="stok" id="edit_stok_barang" class="form-input" required>
                    </div>
                    <div class="form-group">
                        <label for="edit_minimum_stok_barang" class="form-label">Minimum Stok</label>
                        <input type="number" name="minimum_stok" id="edit_minimum_stok_barang" class="form-input" required>
                    </div>
                    <div class="form-group">
                        <label for="edit_harga_beli_barang" class="form-label">Harga Beli</label>
                        <input type="number" name="harga_beli" id="edit_harga_beli_barang" class="form-input" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" onclick="closeModal('modal-barang-edit')" class="btn btn-secondary">Batal</button>
