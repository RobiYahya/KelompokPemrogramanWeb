            ...
            <form action="{{ route('barang.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama_barang" class="form-input" placeholder="Masukkan nama barang" required>
                        @error('nama')
                    ...
                    <div class="form-group">
                        <label for="minimum_stok_barang" class="form-label">Minimum Stok</label>
                    ...
                    <div class="form-group">
                        <label for="harga_beli_barang" class="form-label">Harga Beli</label>
                        <input type="number" name="harga_beli" id="harga_beli_barang" class="form-input" placeholder="Masukkan harga beli" required>
                        @error('harga_beli')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
