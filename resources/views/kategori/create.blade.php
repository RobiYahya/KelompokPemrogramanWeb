...
<head>
    ...
    <title>Tambah Kategori - SIGURA</title>
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-purple-600 min-h-screen p-6 hidden lg:block">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('kategori.index') }}" class="flex items-center text-white bg-purple-700 px-4 py-3 rounded-lg">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                    </svg>
                    Kategori
                </a>
                <a href="{{ route('supplier.index') }}" class="flex items-center text-purple-100 hover:bg-purple-700 px-4 py-3 rounded-lg transition">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 p-6 lg:p-8">
            <div class="mb-8">
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Tambah Kategori</h1>
                <p class="text-gray-600">Tambah data kategori baru</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <form action="{{ route('kategori.store') }}" method="POST">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('kategori.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300 transition">
                            Batal
                        </a>
                    </div>
                </form>
