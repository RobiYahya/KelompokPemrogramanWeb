...
<head>
    ...
    <title>Edit Kategori - SIGURA</title>
...
<body class="min-h-screen bg-gray-100">
    <div class="flex">
        ...
        <div class="flex-1 p-6 lg:p-8">
            <div class="mb-8">
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Edit Kategori</h1>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $kategori->nama) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" required>
                        @error('nama')
